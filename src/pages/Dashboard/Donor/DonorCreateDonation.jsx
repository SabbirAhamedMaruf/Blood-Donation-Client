...
const DonorCreateDonation = () => {
  ...
  const handleCreateDonationRequest = (e) => {
    ...
    axiosPublic.post("/createdonationrequests",donationRequest)
    .then(res => {
      if(res.data.success){
      ...
      handleErrorToast("This account is blocked. And can't create donation request!")
    }
      ...
      <div className="w-[90%] lg:w-[80vw] m-auto shadow-lg  md:p-5 lg:p-10 rounded-lg lg:rounded-2xl my-5">
        <div>
          ...
          <form onSubmit={handleCreateDonationRequest} className="py-10">
            ...
            <input
              className="ml-[38%] md:ml-[42%] lg:ml-[6%] px-4 text-center text-xl text-white font-bold rounded-full  py-1 lg:py-2 bg-red-500 disabled:cursor-not-allowed"
              type="submit"
              value="Request"
            />
          </form>
